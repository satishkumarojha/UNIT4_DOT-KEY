...
document
  .querySelector("#cards>div:nth-child(1)")
  .addEventListener("click", () => {
    location.href = "bodyCare.html";
  });
document
  .querySelector("#cards>div:nth-child(2)")
  .addEventListener("click", () => {
    location.href = "hairCare.html";
  });
document
  .querySelector("#cards>div:nth-child(3)")
  .addEventListener("click", () => {
    location.href = "nutrition.html";
  });
document
  .querySelector("#cards>div:nth-child(4)")
  .addEventListener("click", () => {
    location.href = "serum.html";
  });
document
  .querySelector("#cards>div:nth-child(5)")
  .addEventListener("click", () => {
